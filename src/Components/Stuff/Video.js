...
import ViewVideo from './Modals/ViewVideo';
import media from '../../img/vimeo-play-button-png.png';
...
export default class Video extends Component {
    ...
    load = async name => {
        ...
        let response = await axios.get(`${process.env.REACT_APP_API_URL}/students/video`)
    ...
    addComponent = (value) => {
        ...
        let modal = <ViewVideo media={value} removeComponent={this.removeComponent} />
                                                        ...
                                                        <div className="col-12 border p-3" style={{ height: '300px' }}>
                                                            <div className="row align-items-center justify-content-center h-100">
                                                                <div data-toggle="modal" data-target="#exampleModal" onClick={() => this.addComponent(value.file)}>
                                                                    <img className="w-100" src={media} alt='video' onClick={() => this.addComponent(value.file)} />
