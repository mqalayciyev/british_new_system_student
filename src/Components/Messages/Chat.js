...
export default class Chat extends Component {
    ...
    load = async name => {
        ...
        this.setState({ userid: id, myid: student.user.user_info.id })
                    ...
                    <div className="row">
                        <div className="col-12">
                            <form onSubmit={this.sendForm}>
                                <textarea className="form-control" placeholder="Mətn daxil edin..." name="message" rows="3" onChange={this.handleFormData}></textarea>
